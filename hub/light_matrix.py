...
IMAGE_HEART: Final[int] = 1
IMAGE_HEART_SMALL: Final[int] = 2
IMAGE_HAPPY: Final[int] = 3
IMAGE_SMILE: Final[int] = 4
IMAGE_SAD: Final[int] = 5
IMAGE_CONFUSED: Final[int] = 6
IMAGE_ANGRY: Final[int] = 7
IMAGE_ASLEEP: Final[int] = 8
IMAGE_SURPRISED: Final[int] = 9
IMAGE_SILLY: Final[int] = 10
IMAGE_FABULOUS: Final[int] = 11
IMAGE_MEH: Final[int] = 12
IMAGE_YES: Final[int] = 13
IMAGE_NO: Final[int] = 14
IMAGE_CLOCK12: Final[int] = 15
IMAGE_CLOCK1: Final[int] = 16
IMAGE_CLOCK2: Final[int] = 17
IMAGE_CLOCK3: Final[int] = 18
IMAGE_CLOCK4: Final[int] = 19
IMAGE_CLOCK5: Final[int] = 20
IMAGE_CLOCK6: Final[int] = 21
IMAGE_CLOCK7: Final[int] = 22
IMAGE_CLOCK8: Final[int] = 23
IMAGE_CLOCK9: Final[int] = 24
IMAGE_CLOCK10: Final[int] = 25
IMAGE_CLOCK11: Final[int] = 26
IMAGE_ARROW_N: Final[int] = 27
IMAGE_ARROW_NE: Final[int] = 28
IMAGE_ARROW_E: Final[int] = 29
IMAGE_ARROW_SE: Final[int] = 30
IMAGE_ARROW_S: Final[int] = 31
IMAGE_ARROW_SW: Final[int] = 32
IMAGE_ARROW_W: Final[int] = 33
IMAGE_ARROW_NW: Final[int] = 34
IMAGE_GO_RIGHT: Final[int] = 35
IMAGE_GO_LEFT: Final[int] = 36
IMAGE_GO_UP: Final[int] = 37
IMAGE_GO_DOWN: Final[int] = 38
IMAGE_TRIANGLE: Final[int] = 39
IMAGE_TRIANGLE_LEFT: Final[int] = 40
IMAGE_CHESSBOARD: Final[int] = 41
IMAGE_DIAMOND: Final[int] = 42
IMAGE_DIAMOND_SMALL: Final[int] = 43
IMAGE_SQUARE: Final[int] = 44
IMAGE_SQUARE_SMALL: Final[int] = 45
IMAGE_RABBIT: Final[int] = 46
IMAGE_COW: Final[int] = 47
IMAGE_MUSIC_CROTCHET: Final[int] = 48
IMAGE_MUSIC_QUAVER: Final[int] = 49
IMAGE_MUSIC_QUAVERS: Final[int] = 50
IMAGE_PITCHFORK: Final[int] = 51
IMAGE_XMAS: Final[int] = 52
IMAGE_PACMAN: Final[int] = 53
IMAGE_TARGET: Final[int] = 54
IMAGE_TSHIRT: Final[int] = 55
IMAGE_ROLLERSKATE: Final[int] = 56
IMAGE_DUCK: Final[int] = 57
IMAGE_HOUSE: Final[int] = 58
IMAGE_TORTOISE: Final[int] = 59
IMAGE_BUTTERFLY: Final[int] = 60
IMAGE_STICKFIGURE: Final[int] = 61
IMAGE_GHOST: Final[int] = 62
IMAGE_SWORD: Final[int] = 63
IMAGE_GIRAFFE: Final[int] = 64
IMAGE_SKULL: Final[int] = 65
IMAGE_UMBRELLA: Final[int] = 66
IMAGE_SNAKE: Final[int] = 67
SHOWING = 0
SUCCESS = 1
CANCELLED = 2
